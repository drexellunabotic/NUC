...
static const _MotorControl_type_support_symbol_names_t _MotorControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_phoenix, msg, MotorControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_phoenix, msg, MotorControl)),
  }
};
...
{
  return &::ros_phoenix::msg::rosidl_typesupport_cpp::MotorControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_phoenix, msg, MotorControl)() {
  return get_message_type_support_handle<ros_phoenix::msg::MotorControl>();
}
