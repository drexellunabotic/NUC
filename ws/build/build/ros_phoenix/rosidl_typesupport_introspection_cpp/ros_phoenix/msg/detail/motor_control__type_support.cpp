...
{
  new (message_memory) ros_phoenix::msg::MotorControl(_init);
}

void MotorControl_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_phoenix::msg::MotorControl *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorControl_message_member_array[2] = {
  {
    ...
    offsetof(ros_phoenix::msg::MotorControl, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_phoenix::msg::MotorControl, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorControl_message_members = {
  "ros_phoenix::msg",  // message namespace
  "MotorControl",  // message name
  2,  // number of fields
  sizeof(ros_phoenix::msg::MotorControl),
...
get_message_type_support_handle<ros_phoenix::msg::MotorControl>()
{
  return &::ros_phoenix::msg::rosidl_typesupport_introspection_cpp::MotorControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_phoenix, msg, MotorControl)() {
  return &::ros_phoenix::msg::rosidl_typesupport_introspection_cpp::MotorControl_message_type_support_handle;
}
