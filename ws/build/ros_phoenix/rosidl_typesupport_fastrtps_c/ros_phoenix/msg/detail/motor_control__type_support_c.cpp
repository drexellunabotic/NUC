...
#include "ros_phoenix/msg/detail/motor_control__rosidl_typesupport_fastrtps_c.h"
...
using _MotorControl__ros_msg_type = ros_phoenix__msg__MotorControl;
...
static uint32_t _MotorControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_phoenix__msg__MotorControl(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_phoenix__msg__MotorControl;
    is_plain =
      (
...
static size_t _MotorControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_phoenix__msg__MotorControl(
