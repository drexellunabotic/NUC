...
bool ros_phoenix__msg__motor_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_phoenix.msg._motor_control.MotorControl", full_classname_dest, 43) == 0);
  }
  ros_phoenix__msg__MotorControl * ros_message = _ros_message;
  {  // mode
...
PyObject * ros_phoenix__msg__motor_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_phoenix.msg._motor_control");
